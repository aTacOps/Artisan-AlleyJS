...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',  # Correct the BACKEND here
        'DIRS': [],  # Add paths to your templates here
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Redis for Channels (WebSocket backend)
CHANNEL_LAYERS = {
    "default": {
...
#         'NAME': 'AAV3',
#         'USER': 'postgres',
#         'PASSWORD': 'wN0lcG7HD3gqB2na6dBHiZH2tUPeM8Tm',
#         'HOST': 'localhost',
#         'PORT': '10000',
#     }
# }
